...
\end{figure}
        ...
        Para acessar essa parte do sistema é necessário que o usuário esteja autenticado (RFS08,RNF005). Utilizando Sanity, já vem configurado por padrão as opções de \textit{login} com o Google, Github ou E-mail/senha.
        \begin{figure}[H]
    \centering
