...
\coadviser{Prof. Dr. Edson Rodrigues Borges}
...
\printglossary %glossário
% Corpo do TCC
\mainmatter
O \glsboth{ux} é essencial para o sucesso do produto.
O \glslink{ux}{\textit{User Experience (UX)}} é essencial para o sucesso do produto.
\include{text/1_Introducao}
\include{text/2_Referencial_Teorico}
\include{text/3_Metodo}
\include{text/4_Desenvolvimento}
\include{text/5_Resultados}
\include{text/6_Conclusao}
